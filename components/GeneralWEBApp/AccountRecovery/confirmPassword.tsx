    ...
    <GeneralDesign>
      ...
      >
        ...
        <Image
          src={RydeProLogo}
          alt=''
          className='w-[89px] h-[80px] md:inline hidden mt-20 md:mt-0 md:w-[61.94px] md:h-[51.2px]'
          width={75}
          height={52}
        />
        <Button
      ...
      <main
        className={`flex justify-center items-center w-full ${styles['slide-from-right']}`}
      >
        <form
          action=''
          method='post'
          ...
          <div className='min-h-[456px] gap-[120px] flex flex-col'>
            <div className='min-h-[312px] gap-[24px] flex flex-col'>
              <div className='min-h-[232px] gap-[24px] flex flex-col'>
                <label
                  htmlFor='password'
                  className='gap-[8px] min-h-[124px] md:flex hidden flex-col'
                >
                ...
                <label
                  ...
                  className='gap-[8px] min-h-[84px] flex flex-col'
                >
