    ...
    <GeneralDesign>
      ...
      >
        ...
        <Image
          src={RydeProLogo}
          alt=''
          className='w-[106.45px] h-[98px] hidden md:inline md:w-[61.94px] md:h-[51.2px]'
          width={75}
          height={52}
        />
        <Button
              ...
              {options.map((opt, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    />
                    <span className='font-bold text-base leading-[24px] text-center text-[#0E0E0E]'>
                      {text}
                    </span>
                  </div>
                );
