...
const Footer: React.FC = () => {
  return (
    <footer className=' bg-[#070707] text-[#F7F7F7] py-12 px-16 ex:px-4 flex flex-col gap-8 max-md::px-5 max-md::py-8'>
      {/* Container */}
      <section className='container mx-auto'>
        <div className='flex flex-wrap justify-between gap-5'>
          {/* Left Section */}
          <div className='w-[50%] flex flex-col gap-5 max-md:gap-6 ex:w-full'>
            <p className='leading-7 text-base tracking-wider'>
        ...
        <div className='flex justify-between  items-center flex-wrap gap-5 py-5 pb-0 max-md:pb-0 max-md:gap-6'>
          ...
          <p className=' flex gap-1 font-normal max-md:items-center max-md:justify-center max-md:w-full'>
            <span>
