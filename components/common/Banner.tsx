...
const Banner: React.FC = () => {
  ...
  return (
    <section className='relative bg-gradient-to-r from-black/60 via-black/65 to-black/80 flex items-center justify-center text-center text-white h-full px-4 sm:px-8 '>
      {/* Background Video */}
      <video className='absolute top-0 left-0 w-full h-full object-cover z-[-1]' loop autoPlay muted playsInline>
      ...
      <div className='relative z-10 flex flex-col items-center gap-10 pt-10'>
        ...
        <div className='flex flex-col items-center justify-center gap-[3.2rem]'>
          <div className='ultimate flex flex-col items-center justify-center gap-[1rem]'>
            ...
            <p className='text-[20px] font-normal fd:text-[20px] sm:text-base lg:text-lg w-[70%] zx:text-[16px] leading-6 ax:text-[1.2rem]'>
              Experience Premium to Luxury with our on-demand Chauffeur services, seamless airport transfers, and
              worldwide rideshare services.
            </p>
          </div>
          ...
          <div className='flex flex-col gap-[32px] items-center justify-center w-full '>
            ...
            <div className='flex flex-col justify-center items-center gap-[8px]'>
              <div className='flex flex-col items-center justify-center gap-2 mt-4'>
                <span className='text-[18px] font-normal text-[#DADADA]'>
                  Limited time offer. Hurry, this offer ends soon!
                </span>
                <Link href='#' className='text-[#DADADA] text-[18px] font-normal underline'>
          ...
          <div className='flex flex-col items-center justify-center gap-[24px]'>
            ...
            <div className='flex flex-col items-center gap-4'>
              <span className='text-[20px] font-normal'>Sign Up via Web:</span>
