    ...
    >
      ...
      <div className='px-24 py-16 flex flex-col gap-10 ex:items-start ex:px-5 border'>
        ...
        <div className='servicesInnerHeader flex flex-col items-center gap-2 text-center'>
          <span className='text-[16PX] font-normal uppercase tracking-wide'>Our Services</span>
        ...
        <div className='flex ex:gap-12 flex-col items-end justify-center ex:just  gap-[3rem]'>
            ...
            <div className=' flex flex-col gap-16'>
              <div className='first flex justify-end gap-16'>
                <div className='notesRec flex flex-col gap-4 border-t border-image-gradient-border pt-3 '>
                  ...
                  <p className='text-[#D0D0D0] text-center'>On-demand rides at your fingertips with RYDEPRO.</p>
                </div>
                <div className='notesRec flex flex-col gap-4 border-t border-image-gradient-border pt-3 pb-8 '>
                  <h2 className='text-[24px] font-semibold text-[#FCFCFC] text-center md:text-left'>Round Trip</h2>
              ...
              <div className='second flex gap-[24px]'>
                ...
                <div className='notesRec flex flex-col gap-4 border-t border-image-gradient-border pt-3 '>
                  <h2 className='text-[24px] font-semibold text-[#FCFCFC] text-center md:text-left'>One-Way Trip</h2>
                  <p className='text-[#D0D0D0] text-center md:text-left'>
                ...
                <div className='notesRec hidden ex:flex flex flex-col gap-4 border-t border-image-gradient-border pt-3 pb-8 '>
                  <h2 className='text-[24px] font-semibold text-white text-center md:text-left'>Multi-Stop Journey</h2>
                  <p className='text-[#D0D0D0] text-center md:text-left'>Great for trips with multiple destinations.</p>
                </div>
              </div>
              ...
              <div className='third ex:hidden flex gap-[24px]'>
                ...
                <div className='notesRec flex flex-col gap-4 border-t border-image-gradient-border pt-3 '>
                  <h2 className='text-xl font-semibold text-[#FCFCFC] text-center md:text-left'>Hourly Ride</h2>
                  <p className='text-[#D0D0D0] text-center md:text-left'>
          ...
          <div className='flex ex:flex-col  gap-3 justify-center'>
            <div className='hidden ex:flex ex:gap-6 '>
              ...
              <div className='notesRec flex flex-col gap-4 border-t border-image-gradient-border pt-3 '>
                <h2 className='text-[24px] font-semibold text-[#FCFCFC] text-center md:text-left'>Multi-Stop</h2>
                <p className='text-[#D0D0D0] text-center md:text-left'>Over 1,000 vehicles available for any event.</p>
              </div>
            </div>
            <div className='hidden ex:flex ex:gap-6 '>
              <div className='notesRec flex flex-col gap-4 border-t border-image-gradient-border pt-3 '>
              ...
              <div className='notesRec flex flex-col gap-4 border-t border-image-gradient-border pt-3 '>
                <h2 className='text-[24px] font-semibold text-[#FCFCFC] text-center md:text-left'>Clone Trip</h2>
                <p className='text-[#D0D0D0] text-center md:text-left'>
            ...
            <div className='notesRec flex flex-col gap-4 border-t border-image-gradient-border pt-3  ex:hidden'>
              <h2 className='text-[24px] font-semibold text-[#FCFCFC] text-center md:text-left'>Multi-Trip Booking</h2>
              <p className='text-[#D0D0D0] text-center md:text-left'>
                Book multiple trips with different vehicles and drop-off locations in one go.
              </p>
            </div>
