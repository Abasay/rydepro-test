  ...
  return (
    ...
    >
      ...
      <div className='w-full bg-black bg-opacity-60 h-full grid place-items-center px-[6%]'>
        <div className='flex items-center container gap-6 relative max-h-[188px] min-h-[104px] h-[104px] max-[430px]:h-[148px] max-[360px]:h-[198px]'>
          ...
          <div className={`relative tracking-wider flex w-full ${styles['slide-in']}`}>
            ...
            >
              ...
              <span
                id='hero-description'
                className='min-w-[200px] font-normal max-w-[978px] max-md:text-sm max-[430px]:text-xs text-base text-[#F5F5F5] tracking-wide'
              >
