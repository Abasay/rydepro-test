...
import LoadingBalls from '../Loaders';
...
const ChatBot = ({ isClicked, setIsClicked, userImg }: IndexProps) => {
    ...
    isClicked && (
      ...
      >
        ...
        <FontAwesomeIcon icon={faClose}/>
          ...
          <div
            className={`${styles.chatWallPaper} w-full md:max-w-[350px] border h-[400px] overflow-y-scroll scrollbar-hide rounded-md p-2`}
          >
            <div className='header h-[40px] w-full bg-white rounded-md border flex items-center pl-2 gap-3'>
              ...
              <span className='text-sm'>RYDEPRO Support</span>
            </div>
