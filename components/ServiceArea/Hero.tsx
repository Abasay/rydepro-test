      ...
      <div className='w-full  bg-black bg-opacity-60 h-full grid place-items-center px-[6%]'>
        <div className='flex items-center container   gap-6  relative max-h-[188px] min-h-[104px] h-[104px] max-430:h-[148px] max-360:h-[198px]'>
          ...
          <div className={`relative tracking-wider   flex w-full ${styles['slide-in']}`}>
            <h1 className='font-medium flex flex-col items-start gap-4 text-[#FCFCFC] max-md:text-[20px] max-md:leading-8 text-[32px] leading-10 '>
              <span className=' font-bold'>
                RYDEPRO: <span className=' font-normal'>Expanding Our Horizons</span>
              </span>
              <span className='min-w-[200px] font-normal max-w-[978px] text-base text-[#F5F5F5] tracking-wide '>
