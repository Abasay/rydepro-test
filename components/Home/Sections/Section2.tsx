...
const Section2 = () => {
  ...
  return (
    <section
      className={clsx(
        'w-full min-h-[700px]  bg-black max-md:min-h-[1200px] max-[432px]:min-h-[1150px] max-[370px]:min-h-[1200px] max-[320px]:min-h-[1300px] max-[283px]:min-h-[1500px] flex items-end relative'
      )}
    >
      {/* <div
        ref={ref}
