...
const Hero = () => {
  return (
    <section
      ...
      className='w-full min-h-[632px] max-h-[930px]  max-[[505px]px]:min-h-[610px] transition-all delay-0 duration-300 ease-in-out  md:min-h-[700px] min-[800px]:min-h-[632px]  max-sm:  relative'
    >
      {/* Background Image */}
      <Image
        src={bg}
      ...
      <div className='absolute z-20 w-full bg-black bg-opacity-35 h-full top-0 flex lg:justify-center items-center px-14 py-20 max-md:px-5 lg:px-24'>
        <div className='container mx-auto  h-full flex flex-col max-[430px]:gap-5 gap-8'>
          {/* Section Heading */}
          <h1 id='hero-heading' className='text-[#D0D0D0] text-xl max-[430px]:text-lg font-medium md:text-2xl '>
            RYDEPRO
          </h1>
          ...
          <div className='flex flex-col min-w-[200px] min-h-[472px] max-h-[640px] max-w-[930px] max-md:max-w-[677px] gap-5'>
            <h2
              className='text-[32px] max-[505px]:text-2xl font-semibold leading-10 md:text-5xl   text-[#F7F7F7]'
              aria-describedby='hero-description'
            >
              Join Our Elite Teams of Independent Driver Operators
            </h2>
            <p
              className='text-base max-[430px]:text-sm text-[#D0D0D0] md:text-xl leading-[24px] font-medium w-full '
              id='hero-description'
            >
            ...
            <br className='max-[505px]:hidden' />
            <p className='text-base max-[430px]:text-sm text-[#D0D0D0] md:text-xl md:leading-[32px] leading-[24px] font-medium w-full '>
