...
const Section5 = () => {
  return (
    <section
      className='min-h-[400px] container mx-auto w-full flex justify-center lg:py-10 py-0 pt-0 px-4 md:px-8 lg:px-10 md:mt-6 lg:mt-0 mb-10'
      aria-labelledby='join-RYDEPRO-today'
    >
      <div className='flex flex-col md:flex-row justify-between items-center md:min-h-[400px] md:gap-10 lg:gap-10'>
        <article className='md:w-1/2 w-[335px] max-md:w-full mx-auto flex flex-col gap-6 justify-center h-[400px]'>
          <header className='flex flex-col gap-2' id='join-RYDEPRO-today'>
