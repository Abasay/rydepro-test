...
const Section3 = () => {
  return (
    <section
      className='min-h-[400px] mx-auto container flex justify-center py-8 pb-0 lg:py-10 relative px-4 md:px-8 lg:px-10 md:mt-6'
      aria-labelledby='driver-operator-responsibilities'
    >
      <div className='flex max-md:flex-col-reverse flex-row justify-between min-h-[300px] mt-6 md:mt-0 gap-20 md:gap-10 lg:gap-14'>
        <article className='min-h-[400px] max-md:max-w-[700px] max-md:min-h-[450px] max-md:max-h-[450px] max-[480px]:min-h-[350px] max-[480px]:max-h-[400px] max-sm:min-w-[400px] max-[430px]:min-w-[200px] max-[360px]:max-h-[300px] rounded-3xl lg:min-w-[424px] md:w-full max-md:w-full w-[335px] mx-auto mb-10 lg:mb-0'>
          <Image
            src={img}
            alt=''
            width={400}
        ...
        <div className='w-[335px] max-md:w-full mx-auto md:w-full flex flex-col gap-2 md:justify-center md:mt-0'>
          <header className='flex flex-col gap-1 justify-center' id='driver-operator-responsibilities'>
            <h2 className='text-[#3C3C3C] text-base leading-[24px] font-normal'>Responsibility</h2>
            <h3 className='text-[24px] leading-[32px] font-medium md:text-[40px] md:leading-[48px] text-[#0E0E0E]'>
