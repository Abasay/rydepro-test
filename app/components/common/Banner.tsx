  ...
  return (
    <section className="relative flex items-center justify-center text-center text-white h-screen overflow-hidden px-4 pb-20 sm:px-8 ">
      ...
      <div className="relative z-10 flex flex-col items-center gap-8 pt-20">
        {/* Title */}
        <span className="text-lg sm:text-2xl font-light">RYDEPRO</span>
        <h1 className="text-2xl sm:text-4xl lg:text-5xl font-normal w-[90%] max-w-3xl">
        ...
        <div className=" p-4 rounded-lg text-center max-w-5xl w-full">
          ...
          <div className="flex flex-row md:flex-wrap justify-center gap-4 mt-4 w-[100%]">
            <span className="border border-yellow-400 px-4 py-2 rounded-full bg-white bg-opacity-10">
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <button className="bg-white text-gray-900 px-6 py-2 rounded-lg font-semibold hover:bg-orange-600 hover:text-white transition">
