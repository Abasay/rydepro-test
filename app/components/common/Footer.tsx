...
const Footer: React.FC = () => {
  return (
    <footer className="bottline bg-black text-white py-12 px-16 ex:px-4 flex flex-col gap-8 fd:px-4 fd:py-4">
      {/* Container */}
      <div className="flex flex-wrap justify-between gap-5">
        {/* Left Section */}
        <div className="moreres w-[50%] flex flex-col gap-5 ex:w-full">
        ...
        {/* Right Section */}
        <div className="liners flex gap-12 relative  ex:w-full ex:justify-between p-2 cx:items-center">
