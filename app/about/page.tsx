        ...
        return (
          <div className='text-left w-full max-w-2xl'>
            ...
            >
              ...
              <em>integrity, discipline,</em> and <em>excellence</em> learned in
              the military. Our commitment to these principles ensures that
        ...
        return (
          <div className='text-left w-full max-w-2xl'>
            ...
            <p
              ...
              style={{ fontSize: '18px' }}
            >
              We&apos;re committed to making every ride great for you. From
              faster response times to more comfortable and eco-friendly
              vehicles, we prioritize your comfort and convenience.
            </p>
            Our fleet includes:
        ...
        return (
          <div className='text-left w-full max-w-2xl '>
            ...
            <p
              ...
              style={{ fontSize: '18px' }}
            >
              We believe transportation should be accessible to everyone. Our
              services cater to individuals with diverse needs, including those
              with disabilities. We offer features like wheelchairs- accessible
              vehicles (coming soon) and in-app options to request special
              assistance, ensuring everyone can travel with ease and dignity. We
              comply with the Americans with Disabilities Act and the Convention
        ...
        return (
          <div className='bg-white p-6 rounded-lg shadow-md text-center w-full max-w-2xl'>
            ...
            <p
              ...
              style={{ fontSize: '18px' }}
            >
              Select a topic from the sidebar to learn more about our mission
              and values.
            </p>
          </div>
        );
                ...
                <div>
                  ...
                  {[
                    ...
                    <ul className='ml-4 mt-2 space-y-2'>
                      ...
                      <li
                        className={`text-gray-600 hover:text-black cursor-pointer ${
                          activeSection === 'Accessibility for All'
                            ? 'underline'
                            : ''
                        }`}
                        onClick={() =>
                          setActiveSection('Accessibility for All')
                        }
                      >
                        Accessibility for All
                      </li>
